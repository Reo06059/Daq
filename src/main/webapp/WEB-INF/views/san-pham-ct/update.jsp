...
<body>
<div class="d-flex justify-content-center"><h2>Sửa Sản Phẩm Chi Tiết</h2></div>

<form:form action="/nem/update-san-pham-ct" method="post" modelAttribute="sanPhamCT">
    <div class="mb-3">
    ...
    <form:button onclick="return confirm('Bạn chắc chắn sửa sản phẩm chi tiết?')" type="submit"
                 class="btn btn-primary">Sửa</form:button>
</form:form>
