...
<form:form action="/nem/add-san-pham" method="post" modelAttribute="sanPham">
    <%--    <div class="mb-3">--%>
    <%--        <label for="productId" class="form-label">ID</label>--%>
    <%--        <form:input path="id" class="form-control" id="productId" />--%>
    ...
    <form:button onclick="return confirm('Bạn chắc chắn thêm sản phẩm?')" type="submit"
